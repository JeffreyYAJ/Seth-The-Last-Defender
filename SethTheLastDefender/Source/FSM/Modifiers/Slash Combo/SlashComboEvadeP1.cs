...
{
    public class SlashComboEvadeP1 : StateModifierBase  // Gere le cas du follow up de l'evade
    {
        public override string BindState => "Cross Up Evade";

        private const string DecisionStateName = "P1 Slash Combo Cross Up Decision";
        ...
        public SlashComboEvadeP1(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var dec = new FsmState(fsm.Fsm)
            {
                ...
                Actions = new FsmStateAction[]
                {
                    new WeightedRandomEventAction()
                    {
                        ...
                        weights = new float[] { 0.25f, 0.26f, 0.20f, 0.26f, 0.03f }
                    }
                },
                Transitions = new[]
                {
