...
{
    public class SlashComboEvadeP3 : StateModifierBase  // Gere le cas du follow up de l'evade
    {
        public override string BindState => "Cross Up Evade";

        private const string DecisionStateName = "P3 Slash Combo Cross Up Decision";
        ...
        public SlashComboEvadeP3(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
