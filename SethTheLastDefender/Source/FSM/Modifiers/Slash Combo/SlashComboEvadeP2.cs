...
{
    public class SlashComboEvadeP2 : StateModifierBase  // Gere le cas du follow up de l'evade
    {
        public override string BindState => "Cross Up Evade";

        private const string DecisionStateName = "P2 Slash Combo Cross Up Decision";
        ...
        public SlashComboEvadeP2(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var dec = new FsmState(fsm.Fsm)
            {
                ...
                Actions = new FsmStateAction[]
                {
                    new WeightedRandomEventAction()
                    {
                        ...
                        weights = new float[] { 0.2f, 0.21f, 0.35f, 0.21f, 0.03f }
                    }
                },
                Transitions = new[]
                {
