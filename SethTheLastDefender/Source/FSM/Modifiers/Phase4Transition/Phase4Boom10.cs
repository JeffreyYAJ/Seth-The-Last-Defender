...
namespace SethPrime
{
    public class Phase4Boom10 : StateModifierBase
    {
        public override string BindState => "Phase 4 Boom 10";

        public Phase4Boom10(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Tele Move",
                        ToFsmState = fsm.Fsm.GetState("Tele Move")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Phase 4 Boom 10 créé (Explosion 8)");
        }
