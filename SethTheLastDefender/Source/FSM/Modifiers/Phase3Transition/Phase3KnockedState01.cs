...
namespace SethPrime
{
    public class Phase3KnockedState01 : StateModifierBase
    {
        public override string BindState => "Phase 3 Knocked 01";

        public Phase3KnockedState01(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Phase 3 Knocked",
                        ToFsmState = fsm.Fsm.GetState("Phase 3 Knocked")
                    }
                }
            };
