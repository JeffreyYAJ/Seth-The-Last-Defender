...
{
    public class CycloneModifierP4 : StateModifierBase  // Gere le cas du follow up au sommet du Cyclone
    {
        public override string BindState => "Fade Slash 1";

        private const string DecisionStateName = "P4 Cyclone Top Decision";
        ...
        public CycloneModifierP4(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
