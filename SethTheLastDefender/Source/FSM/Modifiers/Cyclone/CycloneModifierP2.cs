...
{
    public class CycloneModifierP2 : StateModifierBase  // Gere le cas du follow up au sommet du Cyclone
    {
        public override string BindState => "Fade Slash 1";

        private const string DecisionStateName = "P2 Cyclone Top Decision";
        ...
        public CycloneModifierP2(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var dec = new FsmState(fsm.Fsm)
            {
                ...
                Actions = new FsmStateAction[]
                {
                    new WeightedRandomEventAction()
                    {
                        ...
                        weights = new [] { 0.35f, 0.325f, 0.325f }
                    }
                },
                Transitions = new[]
                {
