...
namespace SethPrime
{
    public class Combo86 : StateModifierBase
    {
        public override string BindState => "Combo 86";

        private const string SlashLState = "Combo 86 Slash L";
        private const string SlashRState = "Combo 86 Slash R";

        public Combo86(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 87",
                        ToFsmState = fsm.Fsm.GetState("Combo 87")
                    }
                }
            };
