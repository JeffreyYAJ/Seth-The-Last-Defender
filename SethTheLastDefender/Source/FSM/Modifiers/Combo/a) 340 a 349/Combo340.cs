...
namespace SethPrime
{
    public class Combo340 : StateModifierBase
    {
        public override string BindState => "Combo 340";

        public Combo340(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 341",
                        ToFsmState = fsm.Fsm.GetState("Combo 341")
                    }
                }
            };
