...
namespace SethPrime
{
    public class Combo345 : StateModifierBase
    {
        public override string BindState => "Combo 345";

        public Combo345(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 346",
                        ToFsmState = fsm.Fsm.GetState("Combo 346")
                    }
                }
            };
