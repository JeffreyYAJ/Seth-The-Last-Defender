...
namespace SethPrime
{
    public class Combo342 : StateModifierBase
    {
        public override string BindState => "Combo 342";

        public Combo342(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 343",
                        ToFsmState = fsm.Fsm.GetState("Combo 343")
                    }
                }
            };
