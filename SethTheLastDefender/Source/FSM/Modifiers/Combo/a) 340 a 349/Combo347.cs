...
namespace SethPrime
{
    public class Combo347 : StateModifierBase
    {
        public override string BindState => "Combo 347";

        public Combo347(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 348",
                        ToFsmState = fsm.Fsm.GetState("Combo 348")
                    }
                }
            };
