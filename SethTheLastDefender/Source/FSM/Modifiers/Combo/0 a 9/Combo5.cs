...
namespace SethPrime
{
    public class Combo5 : StateModifierBase
    {
        public override string BindState => "Combo 5"; //aligne Y

        public Combo5(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 6",
                        ToFsmState = fsm.Fsm.GetState("Combo 6")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 5 créé");
        }
