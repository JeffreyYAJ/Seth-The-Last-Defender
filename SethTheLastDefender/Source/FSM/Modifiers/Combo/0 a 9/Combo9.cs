...
namespace SethPrime
{
    public class Combo9 : StateModifierBase
    {
        public override string BindState => "Combo 9";

        public Combo9(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 10",
                        ToFsmState = fsm.Fsm.GetState("Combo 10")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 9 créé");
        }
