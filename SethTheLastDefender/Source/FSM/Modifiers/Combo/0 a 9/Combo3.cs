...
namespace SethPrime
{
    public class Combo3 : StateModifierBase
    {
        public override string BindState => "Combo 3";

        public Combo3(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 4",
                        ToFsmState = fsm.Fsm.GetState("Combo 4")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 3 créé");
        }
