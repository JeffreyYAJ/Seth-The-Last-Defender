...
namespace SethPrime
{
    public class Combo339 : StateModifierBase
    {
        public override string BindState => "Combo 339";

        private const string SlashLState = "Combo 339 Slash L";
        private const string SlashRState = "Combo 339 Slash R";

        public Combo339(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 340",
                        ToFsmState = fsm.Fsm.GetState("Combo 340")
                    }
                }
            };
