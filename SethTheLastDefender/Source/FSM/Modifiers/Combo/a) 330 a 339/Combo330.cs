...
namespace SethPrime
{
    public class Combo330 : StateModifierBase
    {
        public override string BindState => "Combo 330";

        public Combo330(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 331",
                        ToFsmState = fsm.Fsm.GetState("Combo 331")
                    }
                }
            };
