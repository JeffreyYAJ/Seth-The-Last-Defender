...
namespace SethPrime
{
    public class Combo220 : StateModifierBase
    {
        public override string BindState => "Combo 220";

        public Combo220(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 221",
                        ToFsmState = fsm.Fsm.GetState("Combo 221")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 220 créé");
        }
