...
namespace SethPrime
{
    public class Combo227 : StateModifierBase
    {
        public override string BindState => "Combo 227";

        public Combo227(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 228",
                        ToFsmState = fsm.Fsm.GetState("Combo 228")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 227 créé");
        }
