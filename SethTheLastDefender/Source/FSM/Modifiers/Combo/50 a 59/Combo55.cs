...
namespace SethPrime
{
    public class Combo55 : StateModifierBase
    {
        public override string BindState => "Combo 55";

        private const string ThrowLState = "Combo 55 Throw L";
        private const string ThrowRState = "Combo 55 Throw R";

        public Combo55(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo55] Etats décision + Throw créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 56",
                        ToFsmState = fsm.Fsm.GetState("Combo 56")
                    }
                }
            };
