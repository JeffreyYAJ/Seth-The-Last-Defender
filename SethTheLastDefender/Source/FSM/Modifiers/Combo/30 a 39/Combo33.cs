...
namespace SethPrime
{
    public class Combo33 : StateModifierBase
    {
        public override string BindState => "Combo 33";

        private const string SlashLState = "Combo 33 Slash L";
        private const string SlashRState = "Combo 33 Slash R";

        public Combo33(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo33] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 34",
                        ToFsmState = fsm.Fsm.GetState("Combo 34")
                    }
                }
            };
