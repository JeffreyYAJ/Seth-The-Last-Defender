...
namespace SethPrime
{
    public class Combo315 : StateModifierBase
    {
        public override string BindState => "Combo 315";

        public Combo315(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 316",
                        ToFsmState = fsm.Fsm.GetState("Combo 316")
                    }
                }
            };
