...
namespace SethPrime
{
    public class Combo313 : StateModifierBase
    {
        public override string BindState => "Combo 313";

        public Combo313(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 314",
                        ToFsmState = fsm.Fsm.GetState("Combo 314")
                    }
                }
            };
