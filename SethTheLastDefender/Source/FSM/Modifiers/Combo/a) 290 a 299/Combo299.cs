...
namespace SethPrime
{
    public class Combo299 : StateModifierBase
    {
        public override string BindState => "Combo 299";

        public Combo299(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 300",
                        ToFsmState = fsm.Fsm.GetState("Combo 300")
                    }
                }
            };
