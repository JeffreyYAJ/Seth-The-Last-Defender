...
namespace SethPrime
{
    public class Combo19 : StateModifierBase
    {
        public override string BindState => "Combo 19";

        public Combo19(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 20",
                        ToFsmState = fsm.Fsm.GetState("Combo 20")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 19 créé");
        }
