...
namespace SethPrime
{
    public class Combo13 : StateModifierBase
    {
        public override string BindState => "Combo 13";

        public Combo13(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 14",
                        ToFsmState = fsm.Fsm.GetState("Combo 14")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 13 créé");
        }
