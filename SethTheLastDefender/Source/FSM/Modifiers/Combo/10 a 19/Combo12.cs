...
namespace SethPrime
{
    public class Combo12 : StateModifierBase
    {
        public override string BindState => "Combo 12";

        private const string ThrowLState = "Combo 12 Throw L";
        private const string ThrowRState = "Combo 12 Throw R";

        public Combo12(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo12] Etats décision + Throw créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 13",
                        ToFsmState = fsm.Fsm.GetState("Combo 13")
                    }
                }
            };
