...
namespace SethPrime
{
    public class Combo328 : StateModifierBase
    {
        public override string BindState => "Combo 328";

        public Combo328(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 329",
                        ToFsmState = fsm.Fsm.GetState("Combo 329")
                    }
                }
            };
