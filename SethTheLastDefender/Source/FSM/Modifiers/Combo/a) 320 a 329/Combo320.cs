...
namespace SethPrime
{
    public class Combo320 : StateModifierBase
    {
        public override string BindState => "Combo 320";

        public Combo320(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 321",
                        ToFsmState = fsm.Fsm.GetState("Combo 321")
                    }
                }
            };
