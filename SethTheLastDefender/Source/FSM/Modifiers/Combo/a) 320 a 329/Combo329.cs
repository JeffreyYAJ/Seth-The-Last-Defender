...
namespace SethPrime
{
    public class Combo329 : StateModifierBase
    {
        public override string BindState => "Combo 329";

        private const string SlashLState = "Combo 329 Slash L";
        private const string SlashRState = "Combo 329 Slash R";

        public Combo329(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 330",
                        ToFsmState = fsm.Fsm.GetState("Combo 330")
                    }
                }
            };
