...
namespace SethPrime
{
    public class Combo325 : StateModifierBase
    {
        public override string BindState => "Combo 325";

        public Combo325(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 326",
                        ToFsmState = fsm.Fsm.GetState("Combo 326")
                    }
                }
            };
