...
namespace SethPrime
{
    public class Combo324 : StateModifierBase
    {
        public override string BindState => "Combo 324";

        public Combo324(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 325",
                        ToFsmState = fsm.Fsm.GetState("Combo 325")
                    }
                }
            };
