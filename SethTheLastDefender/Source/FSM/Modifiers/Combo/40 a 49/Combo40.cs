...
namespace SethPrime
{
    public class Combo40 : StateModifierBase
    {
        public override string BindState => "Combo 40";

        private const string SlashLState = "Combo 40 Slash L";
        private const string SlashRState = "Combo 40 Slash R";

        public Combo40(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo40] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 41",
                        ToFsmState = fsm.Fsm.GetState("Combo 41")
                    }
                }
            };
