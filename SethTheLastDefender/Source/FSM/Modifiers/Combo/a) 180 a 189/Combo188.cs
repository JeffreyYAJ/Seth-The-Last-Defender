...
namespace SethPrime
{
    public class Combo188 : StateModifierBase
    {
        public override string BindState => "Combo 188";

        private const string SlashLState = "Combo 188 Slash L";
        private const string SlashRState = "Combo 188 Slash R";

        public Combo188(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo188] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 189",
                        ToFsmState = fsm.Fsm.GetState("Combo 189")
                    }
                }
            };
