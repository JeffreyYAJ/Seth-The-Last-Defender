...
namespace SethPrime
{
    public class Combo212 : StateModifierBase
    {
        public override string BindState => "Combo 212";

        public Combo212(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 213",
                        ToFsmState = fsm.Fsm.GetState("Combo 213")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 212 créé");
        }
