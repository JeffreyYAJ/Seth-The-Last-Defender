...
namespace SethPrime
{
    public class Combo155 : StateModifierBase
    {
        public override string BindState => "Combo 155";

        private const string SlashLState = "Combo 155 Slash L";
        private const string SlashRState = "Combo 155 Slash R";

        public Combo155(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo155] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 156",
                        ToFsmState = fsm.Fsm.GetState("Combo 156")
                    }
                }
            };
