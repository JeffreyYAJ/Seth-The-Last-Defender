...
namespace SethPrime
{
    public class Combo152 : StateModifierBase
    {
        public override string BindState => "Combo 152";

        public Combo152(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 153",
                        ToFsmState = fsm.Fsm.GetState("Combo 153")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 152 créé");
        }
