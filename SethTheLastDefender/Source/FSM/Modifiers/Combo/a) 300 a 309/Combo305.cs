...
namespace SethPrime
{
    public class Combo305 : StateModifierBase
    {
        public override string BindState => "Combo 305";

        public Combo305(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 306",
                        ToFsmState = fsm.Fsm.GetState("Combo 306")
                    }
                }
            };
