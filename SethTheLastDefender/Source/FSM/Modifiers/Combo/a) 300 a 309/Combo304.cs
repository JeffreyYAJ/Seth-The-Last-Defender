...
namespace SethPrime
{
    public class Combo304 : StateModifierBase
    {
        public override string BindState => "Combo 304";

        public Combo304(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 305",
                        ToFsmState = fsm.Fsm.GetState("Combo 305")
                    }
                }
            };
