...
namespace SethPrime
{
    public class Combo309 : StateModifierBase
    {
        public override string BindState => "Combo 309";

        public Combo309(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 310",
                        ToFsmState = fsm.Fsm.GetState("Combo 310")
                    }
                }
            };
