...
namespace SethPrime
{
    public class Combo124 : StateModifierBase
    {
        public override string BindState => "Combo 124";

        public Combo124(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 125",
                        ToFsmState = fsm.Fsm.GetState("Combo 125")
                    }
                }
            };
