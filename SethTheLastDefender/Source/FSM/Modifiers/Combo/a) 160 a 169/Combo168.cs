...
namespace SethPrime
{
    public class Combo168 : StateModifierBase
    {
        public override string BindState => "Combo 168";

        private const string SlashLState = "Combo 168 Slash L";
        private const string SlashRState = "Combo 168 Slash R";

        public Combo168(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo168] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 169",
                        ToFsmState = fsm.Fsm.GetState("Combo 169")
                    }
                }
            };
