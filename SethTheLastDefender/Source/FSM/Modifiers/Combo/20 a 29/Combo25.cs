...
namespace SethPrime
{
    public class Combo25 : StateModifierBase
    {
        public override string BindState => "Combo 25";

        public Combo25(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 26",
                        ToFsmState = fsm.Fsm.GetState("Combo 26")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 25 créé");
        }
