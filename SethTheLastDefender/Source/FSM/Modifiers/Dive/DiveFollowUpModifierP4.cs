...
{
    public class DiveFollowUpModifierP4 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P4 Dive Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Dive Land" };

        public DiveFollowUpModifierP4(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
