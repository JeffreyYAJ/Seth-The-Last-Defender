...
namespace SethPrime
{
    public class StabTP2 : StateModifierBase
    {
        public override string BindState => "Stab TP 2";

        private const string SlashLState = "Stab TP 2 Slash L";
        private const string SlashRState = "Stab TP 2 Slash R";

        public StabTP2(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("Etats Stab TP 2 décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Stab TP 3",
                        ToFsmState = fsm.Fsm.GetState("Stab TP 3")
                    }
                }
            };
