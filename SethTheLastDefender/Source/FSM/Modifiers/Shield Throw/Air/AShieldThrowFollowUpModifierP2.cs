...
{
    public class AShieldThrowFollowUpModifierP2 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P2 AShield Throw Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Catch Air" };

        public AShieldThrowFollowUpModifierP2(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
