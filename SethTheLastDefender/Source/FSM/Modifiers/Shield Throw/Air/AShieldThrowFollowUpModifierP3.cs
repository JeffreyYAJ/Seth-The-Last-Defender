...
{
    public class AShieldThrowFollowUpModifierP3 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P3 AShield Throw Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Catch Air" };

        public AShieldThrowFollowUpModifierP3(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
