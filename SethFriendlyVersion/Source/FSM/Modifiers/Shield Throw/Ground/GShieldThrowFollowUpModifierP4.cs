...
{
    public class GShieldThrowFollowUpModifierP4 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P4 GShield Throw Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Catch Ground" };

        public GShieldThrowFollowUpModifierP4(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
