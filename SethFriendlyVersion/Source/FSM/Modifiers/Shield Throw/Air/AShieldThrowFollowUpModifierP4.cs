...
{
    public class AShieldThrowFollowUpModifierP4 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P4 AShield Throw Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Catch Air" };

        public AShieldThrowFollowUpModifierP4(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
