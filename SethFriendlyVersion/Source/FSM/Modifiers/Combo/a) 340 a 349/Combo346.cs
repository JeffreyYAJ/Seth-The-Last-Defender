...
namespace SethPrime
{
    public class Combo346 : StateModifierBase
    {
        public override string BindState => "Combo 346";

        private const string ThrowLState = "Combo 346 Throw L";
        private const string ThrowRState = "Combo 346 Throw R";

        public Combo346(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 347",
                        ToFsmState = fsm.Fsm.GetState("Combo 347")
                    }
                }
            };
