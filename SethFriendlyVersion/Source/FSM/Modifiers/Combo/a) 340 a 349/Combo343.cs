...
namespace SethPrime
{
    public class Combo343 : StateModifierBase
    {
        public override string BindState => "Combo 343";

        public Combo343(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 344",
                        ToFsmState = fsm.Fsm.GetState("Combo 344")
                    }
                }
            };
