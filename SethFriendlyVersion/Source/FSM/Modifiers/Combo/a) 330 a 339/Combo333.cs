...
namespace SethPrime
{
    public class Combo333 : StateModifierBase
    {
        public override string BindState => "Combo 333";

        public Combo333(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 334",
                        ToFsmState = fsm.Fsm.GetState("Combo 334")
                    }
                }
            };
