...
namespace SethPrime
{
    public class Combo337 : StateModifierBase
    {
        public override string BindState => "Combo 337";

        public Combo337(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 338",
                        ToFsmState = fsm.Fsm.GetState("Combo 338")
                    }
                }
            };
