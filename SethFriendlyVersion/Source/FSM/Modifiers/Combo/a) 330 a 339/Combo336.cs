...
namespace SethPrime
{
    public class Combo336 : StateModifierBase
    {
        public override string BindState => "Combo 336";

        public Combo336(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 337",
                        ToFsmState = fsm.Fsm.GetState("Combo 337")
                    }
                }
            };
