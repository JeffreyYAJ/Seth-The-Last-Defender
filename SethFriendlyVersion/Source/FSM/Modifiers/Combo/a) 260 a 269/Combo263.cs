...
namespace SethPrime
{
    public class Combo263 : StateModifierBase
    {
        public override string BindState => "Combo 263";

        public Combo263(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 264",
                        ToFsmState = fsm.Fsm.GetState("Combo 264")
                    }
                }
            };
