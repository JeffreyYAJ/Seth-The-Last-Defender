...
namespace SethPrime
{
    public class Combo47 : StateModifierBase
    {
        public override string BindState => "Combo 47";

        private const string SlashLState = "Combo 47 Slash L";
        private const string SlashRState = "Combo 47 Slash R";

        public Combo47(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 48",
                        ToFsmState = fsm.Fsm.GetState("Combo 48")
                    }
                }
            };
