...
namespace SethPrime
{
    public class Combo94 : StateModifierBase
    {
        public override string BindState => "Combo 94";

        private const string SlashLState = "Combo 94 Slash L";
        private const string SlashRState = "Combo 94 Slash R";

        public Combo94(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 95",
                        ToFsmState = fsm.Fsm.GetState("Combo 95")
                    }
                }
            };
