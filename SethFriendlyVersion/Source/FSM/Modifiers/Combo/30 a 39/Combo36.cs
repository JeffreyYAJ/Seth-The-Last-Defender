...
namespace SethPrime
{
    public class Combo36 : StateModifierBase
    {
        public override string BindState => "Combo 36";

        public Combo36(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 37",
                        ToFsmState = fsm.Fsm.GetState("Combo 37")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 36 créé");
        }
