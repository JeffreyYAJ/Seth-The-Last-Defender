...
namespace SethPrime
{
    public class Combo206 : StateModifierBase
    {
        public override string BindState => "Combo 206";

        public Combo206(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 207",
                        ToFsmState = fsm.Fsm.GetState("Combo 207")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 206 créé");
        }
