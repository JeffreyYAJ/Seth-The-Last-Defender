...
namespace SethPrime
{
    public class Combo207 : StateModifierBase
    {
        public override string BindState => "Combo 207";

        public Combo207(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 208",
                        ToFsmState = fsm.Fsm.GetState("Combo 208")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 207 créé");
        }
