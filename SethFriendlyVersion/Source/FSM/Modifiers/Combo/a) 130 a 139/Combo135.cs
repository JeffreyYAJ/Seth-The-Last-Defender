...
namespace SethPrime
{
    public class Combo135 : StateModifierBase
    {
        public override string BindState => "Combo 135";

        private const string SlashLState = "Combo 135 Slash L";
        private const string SlashRState = "Combo 135 Slash R";

        public Combo135(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo135] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 136",
                        ToFsmState = fsm.Fsm.GetState("Combo 136")
                    }
                }
            };
