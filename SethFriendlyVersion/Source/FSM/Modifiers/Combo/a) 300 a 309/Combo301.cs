...
namespace SethPrime
{
    public class Combo301 : StateModifierBase
    {
        public override string BindState => "Combo 301";

        private const string SlashLState = "Combo 301 Slash L";
        private const string SlashRState = "Combo 301 Slash R";

        public Combo301(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 302",
                        ToFsmState = fsm.Fsm.GetState("Combo 302")
                    }
                }
            };
