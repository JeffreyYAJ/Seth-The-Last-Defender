...
namespace SethPrime
{
    public class Combo307 : StateModifierBase
    {
        public override string BindState => "Combo 307";

        public Combo307(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 308",
                        ToFsmState = fsm.Fsm.GetState("Combo 308")
                    }
                }
            };
