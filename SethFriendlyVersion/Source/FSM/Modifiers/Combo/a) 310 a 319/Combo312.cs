...
namespace SethPrime
{
    public class Combo312 : StateModifierBase
    {
        public override string BindState => "Combo 312";

        public Combo312(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 313",
                        ToFsmState = fsm.Fsm.GetState("Combo 313")
                    }
                }
            };
