...
namespace SethPrime
{
    public class Combo311 : StateModifierBase
    {
        public override string BindState => "Combo 311";

        public Combo311(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 312",
                        ToFsmState = fsm.Fsm.GetState("Combo 312")
                    }
                }
            };
