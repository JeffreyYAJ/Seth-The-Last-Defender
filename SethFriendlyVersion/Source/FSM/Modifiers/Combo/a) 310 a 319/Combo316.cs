...
namespace SethPrime
{
    public class Combo316 : StateModifierBase
    {
        public override string BindState => "Combo 316";

        private const string SlashLState = "Combo 316 Slash L";
        private const string SlashRState = "Combo 316 Slash R";

        public Combo316(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 317",
                        ToFsmState = fsm.Fsm.GetState("Combo 317")
                    }
                }
            };
