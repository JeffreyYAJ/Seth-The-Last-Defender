...
namespace SethPrime
{
    public class Combo15 : StateModifierBase
    {
        public override string BindState => "Combo 15";

        public Combo15(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 16",
                        ToFsmState = fsm.Fsm.GetState("Combo 16")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 15 créé");
        }
