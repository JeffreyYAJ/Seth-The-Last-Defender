...
namespace SethPrime
{
    public class Combo18 : StateModifierBase
    {
        public override string BindState => "Combo 18";

        public Combo18(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 19",
                        ToFsmState = fsm.Fsm.GetState("Combo 19")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 18 créé");
        }
