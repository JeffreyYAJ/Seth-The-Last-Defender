...
namespace SethPrime
{
    public class Combo17 : StateModifierBase
    {
        public override string BindState => "Combo 17";

        public Combo17(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 18",
                        ToFsmState = fsm.Fsm.GetState("Combo 18")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 17 créé");
        }
