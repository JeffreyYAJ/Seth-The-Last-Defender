...
namespace SethPrime
{
    public class Combo198 : StateModifierBase
    {
        public override string BindState => "Combo 198";

        public Combo198(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 199",
                        ToFsmState = fsm.Fsm.GetState("Combo 199")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 198 créé");
        }
