...
namespace SethPrime
{
    public class Combo199 : StateModifierBase
    {
        public override string BindState => "Combo 199";

        public Combo199(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 200",
                        ToFsmState = fsm.Fsm.GetState("Combo 200")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 199 créé");
        }
