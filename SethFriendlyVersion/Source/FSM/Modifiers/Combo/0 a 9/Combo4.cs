...
namespace SethPrime
{
    public class Combo4 : StateModifierBase
    {
        public override string BindState => "Combo 4";

        private const string ThrowLState = "Combo 4 Throw L";
        private const string ThrowRState = "Combo 4 Throw R";

        public Combo4(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo4] Etats décision + Throw créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 5",
                        ToFsmState = fsm.Fsm.GetState("Combo 5")
                    }
                }
            };
