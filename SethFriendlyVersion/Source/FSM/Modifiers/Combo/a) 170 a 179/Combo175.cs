...
namespace SethPrime
{
    public class Combo175 : StateModifierBase
    {
        public override string BindState => "Combo 175";

        private const string SlashLState = "Combo 175 Slash L";
        private const string SlashRState = "Combo 175 Slash R";

        public Combo175(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo175] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 176",
                        ToFsmState = fsm.Fsm.GetState("Combo 176")
                    }
                }
            };
