...
namespace SethPrime
{
    public class Combo172 : StateModifierBase
    {
        public override string BindState => "Combo 172";

        public Combo172(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 173",
                        ToFsmState = fsm.Fsm.GetState("Combo 173")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 172 créé");
        }
