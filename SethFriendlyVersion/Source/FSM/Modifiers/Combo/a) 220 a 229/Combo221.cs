...
namespace SethPrime
{
    public class Combo221 : StateModifierBase
    {
        public override string BindState => "Combo 221";

        public Combo221(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 222",
                        ToFsmState = fsm.Fsm.GetState("Combo 222")
                    }
                }
            };
