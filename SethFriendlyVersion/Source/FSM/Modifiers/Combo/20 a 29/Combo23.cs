...
namespace SethPrime
{
    public class Combo23 : StateModifierBase
    {
        public override string BindState => "Combo 23";

        public Combo23(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 24",
                        ToFsmState = fsm.Fsm.GetState("Combo 24")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("Etat Combo 23 créé");
        }
