...
namespace SethPrime
{
    public class Combo21 : StateModifierBase
    {
        public override string BindState => "Combo 21";

        public Combo21(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var comboState = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 22",
                        ToFsmState = fsm.Fsm.GetState("Combo 22")
                    }
                }
            };
