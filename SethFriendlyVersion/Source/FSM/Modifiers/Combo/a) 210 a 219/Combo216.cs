...
namespace SethPrime
{
    public class Combo216 : StateModifierBase
    {
        public override string BindState => "Combo 216";

        private const string SlashLState = "Combo 216 Slash L";
        private const string SlashRState = "Combo 216 Slash R";

        public Combo216(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo216] Slash L/R et décision créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 217",
                        ToFsmState = fsm.Fsm.GetState("Combo 217")
                    }
                }
            };
