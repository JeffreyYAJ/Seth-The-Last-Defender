...
namespace SethPrime
{
    public class Combo128 : StateModifierBase
    {
        public override string BindState => "Combo 128";

        private const string SlashLState = "Combo 128 Slash L";
        private const string SlashRState = "Combo 128 Slash R";

        public Combo128(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("[Combo128] Etats décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 129",
                        ToFsmState = fsm.Fsm.GetState("Combo 129")
                    }
                }
            };
