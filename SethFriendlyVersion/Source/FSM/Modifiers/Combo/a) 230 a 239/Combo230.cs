...
namespace SethPrime
{
    public class Combo230 : StateModifierBase
    {
        public override string BindState => "Combo 230";

        private const string SlashL = "Combo 230 Slash L";
        private const string SlashR = "Combo 230 Slash R";

        public Combo230(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 231",
                        ToFsmState = fsm.Fsm.GetState("Combo 231")
                    }
                }
            };
