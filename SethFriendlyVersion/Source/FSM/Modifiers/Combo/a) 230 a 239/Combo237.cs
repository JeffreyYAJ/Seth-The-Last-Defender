...
namespace SethPrime
{
    public class Combo237 : StateModifierBase
    {
        public override string BindState => "Combo 237";

        private const string SlashL = "Combo 237 Slash L";
        private const string SlashR = "Combo 237 Slash R";

        public Combo237(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Combo 238",
                        ToFsmState = fsm.Fsm.GetState("Combo 238")
                    }
                }
            };
