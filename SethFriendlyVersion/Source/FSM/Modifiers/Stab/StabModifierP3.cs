...
{
    public class StabModifierP3 : StateModifierBase
    {
        public override string BindState => "LOL";

        private const string DecisionStateName = "P3 Stab Follow Up Decision";

        // États qui déclenchent le follow-up
        private readonly string[] entryStates = new[] { "Stab Recover" };

        public StabModifierP3(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
