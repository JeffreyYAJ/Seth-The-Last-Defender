...
namespace SethPrime
{
    public class Phase4KnockedState : StateModifierBase
    {
        public override string BindState => "Phase 4 Knocked";

        // ctor : utilise la signature standard du StateModifierBase du projet
        public Phase4KnockedState(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        private void CreateBindState()
        {
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition()
                    {
                        ...
                        ToState = "Phase 4 Recovering State",
                        ToFsmState = fsm.Fsm.GetState("Phase 4 Recovering State")
                    }
                }
            };
            ...
            SethPrimeMain.Log.LogInfo("[Phase4KnockedState] State créé et ajouté au Control FSM : " + BindState);
        }
