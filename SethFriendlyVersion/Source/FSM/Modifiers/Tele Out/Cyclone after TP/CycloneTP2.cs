...
namespace SethPrime
{
    public class CycloneTP2 : StateModifierBase
    {
        public override string BindState => "Cyclone TP 2";

        private const string SlashLState = "Cyclone TP 2 Slash L";
        private const string SlashRState = "Cyclone TP 2 Slash R";

        public CycloneTP2(PlayMakerFSM fsm, PlayMakerFSM stunFsm, SethWrapper wrapper)
        ...
        public override void OnCreateModifier()
        {
            ...
            SethPrimeMain.Log.LogInfo("Etats Cyclone TP 2 décision + Slash créés");
        }
            ...
            var state = new FsmState(fsm.Fsm)
            {
                ...
                Transitions = new[]
                {
                    new FsmTransition
                    {
                        ...
                        ToState = "Cyclone TP 3",
                        ToFsmState = fsm.Fsm.GetState("Cyclone TP 3")
                    }
                }
            };
